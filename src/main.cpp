...
// vector version, hopefully faster than the set version:
...
int main(int argc, char* argv[]) {
    ...
    // std::map<std::string, std::set<ulong> > sw_map;    
    // auto sw_map = load_sw_vec(source, op);

    // test it loads:
    // print_sw_map(sw_map);
    // return 0;

    // test union_size and intersection_size:
