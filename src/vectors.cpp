...
std::vector<std::pair<float, std::string> > pattern_recognition(const std::map<std::string, std::vector<ulong> > &sw_map, const std::vector<ulong> &pattern, ulong number_of_results, float min_similarity) {
